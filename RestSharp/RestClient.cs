...
namespace RestSharp
{
    ...
    public partial class RestClient : IRestClient
    {
        ...
        IDictionary<string, IDeserializer> ContentHandlers { get; set; }
        ...
        void AuthenticateIfNeeded(RestClient client, IRestRequest request)
        {
        ...
        string EncodeParameters(IRestRequest request)
        {
        ...
        void ConfigureHttp(IRestRequest request, IHttp http)
        {
        ...
        RestResponse ConvertToRestResponse(HttpResponse httpResponse)
        {
        ...
        RestResponse<T> Deserialize<T>(IRestRequest request, RestResponse raw) where T : new()
        {
